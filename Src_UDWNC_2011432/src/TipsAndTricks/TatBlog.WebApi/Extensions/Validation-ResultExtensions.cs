...
{
    public  static class Validation_ResultExtensions
    {
        ...
        public static IDictionary<string,List<string>> GetErrorWithPropertyNames(this ValidationResult validationResult )
        {
            return validationResult.Errors.GetErrorWithPropertyNames();

        }
        public static IDictionary<string,List<string>> GetErrorWithPropertyNames(this IEnumerable<ValidationFailure> failures)
        {
            return failures 
